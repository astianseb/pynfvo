...
class NSOConnection(object):
    ...
    def get(self, resource_type, header, media_type, path=None, params=None):
        url = _format_url(self.host, resource_type, path, self.ssl)
        response = self.session.get(
            url,
            headers=self._get_headers(header, media_type),
            params=params)
        try:
    ...
    def get_plain(self, resource_type, header, media_type, path=None, params=None):
        url = _format_url(self.host, resource_type, path, self.ssl)
        response = self.session.get(
            url,
            headers=self._get_headers(header, media_type),
    ...
    def post(self, resource_type, header, media_type, data,
    ...
    def put(self, resource_type, header, media_type, data,
            path=None, params=None):
        url = _format_url(self.host, resource_type, path, self.ssl)
    ...
    def delete(self, resource_type, header, media_type,
               path=None, params=None):
        url = _format_url(self.host, resource_type, path, self.ssl)
    ...
    def _get_headers(self, header, media_type):
        if header == 'Accept':
            return {
